namespace SimisEditor
{
	partial class Editor
	{
		...
		private void InitializeComponent() {
			...
			this.AceImage.SizeMode = System.Windows.Forms.PictureBoxSizeMode.StretchImage;
			this.AceImage.TabIndex = 0;
			this.AceImage.TabStop = false;
			this.AceImage.Paint += new System.Windows.Forms.PaintEventHandler(this.AceImage_Paint);
			// 
			// AceChannels
			// 
